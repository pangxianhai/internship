package cn.edu.swufe.lawschool.internship.assessment.model;
 ...
 * @version 1.0
 */
public class Assessment extends BaseDO {
    /**
     * 学生ID
     */
    Long studentId;
    ...
    public void setTeacherConfirm (Confirm teacherConfirm) {
    ...
    public String getTutorScoreStr () {
        return ScoreUtil.scoreToText(this.tutorScore);
    }
