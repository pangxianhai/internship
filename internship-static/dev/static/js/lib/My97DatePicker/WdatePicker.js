...
define(function (require, exports, module) {
    ...
    (function () {
        ...
        A = L();
        if (_.$wdate)M("/static/js/lib/My97DatePicker/skin/WdatePicker.css");
        V = X;
        if (_.$crossFrame) {
            try {
        ...
        function K(H, $) {
            ...
            if (!$dp.dd || $dp.eCont || ($dp.lang && $dp.realLang && $dp.realLang.name != $dp.lang && $dp.getLangIndex && $dp.getLangIndex($dp.lang) >= 0)) {
                ...
                if (_.$dpPath == "")F(A);
                var B = "<iframe style=\"width:1px;height:1px\" src=\"/static/js/lib/My97DatePicker/My97DatePicker.html\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
                if ($dp.eCont) {
