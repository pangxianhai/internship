define(function (require, exports, module) {
    ...
    Dialog.prototype = {
        ...
        create: function () {
            ...
            var className = "rDialog";
            if (typeof(this.settings.updClass) != "undefined") {
                className = this.settings.updClass;
            }

            // HTML模板
            var templates = '<div class="' + className + '-wrap">' +
                divHeader +
        ...
        updClass: function () {
            $(".rDialog-wrap").addClass(this.settings.className);
        },
        /**
         * ok
         */
        ...
        unLock: function () {
            if (this.settings.lock) {
                if (typeof this.lock.remove == 'function') {
                    this.lock.remove();
                    isLock = false;
                }
            }
